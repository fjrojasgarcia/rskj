...
public class BridgeDevNetConstants extends BridgeConstants {
    ...
    BridgeDevNetConstants() {
        ...
        // Generated with keys 'devnet1-a', 'devnet1-b' and 'devnet1-c', in order
        BtcECKey federator0PublicKey = BtcECKey.fromPublicOnly(Hex.decode("03d68975ab0f6ab782febc37aaa486ae19cc5e72c6900e34e21317285c88915ed6"));
        BtcECKey federator1PublicKey = BtcECKey.fromPublicOnly(Hex.decode("02914c05df0b11862ac6931c226ad40ebc4f5624ee6dca34278d3bbfa73b914cbd"));
        BtcECKey federator2PublicKey = BtcECKey.fromPublicOnly(Hex.decode("0309d9df35855aa45235a04e30d228889eb03e462874588e631359d5f9cdea6519"));
